...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <a href="/obesity-visualizer/app/controllers/bmi_calc.php"><button class="btn">Calculate BMI</button></a>
        </div>
        <div class="card">
        ...
        <div class="card">
            ...
            <a href="/obesity-visualizer/app/controllers/visualize.php"><button class="btn">Visualize Data</button></a>
        </div>
        <div class="card">
