        ...
        <div class="container" id="edit_container" style="display: none;">
            ...
            <div class="container">
                <form action="/obesity-visualizer/public-app/app/models/personal_edit.php" method="post" class="form">
                    ...
                    <input type="number" id="height" name="height" step="0.1" min="0" max="250" value="<?php echo $height ?>">

                    <label for="weight">Weight (kg)</label>
                    <input type="number" id="weight" name="weight" step="0.1" min="0" max="250" value="<?php echo $weight ?>">
